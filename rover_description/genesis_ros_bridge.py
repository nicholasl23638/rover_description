...
class GenesisRosBridge(Node):
    def __init__(self):
        ...
        robot_description_content = str(description_path) + "/urdf/RescueRangersArm.urdf"
        ...
        # /home/ginget/RescueRangers/rescue_rangers_pi_ws/install/rover_description/share/rover_description/RescueRangersArmMeshes/h42p_020_s300_r_dummy2.stl
        # /home/ginget/RescueRangers/rescue_rangers_pi_ws/install/rover_description/RescueRangersArmMeshes/h42p_020_s300_r_dummy2.stl
        # self.jnt_names = [
        #     'R_wheel_diff',
        #     'R_wheel_rocker',
        #     'L_wheel_diff',
